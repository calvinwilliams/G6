...
#define DEFAULT_FORWARD_THREAD_COUNT		2	/* ×ª·¢Ïß³ÌÊıÁ¿ */
#define DEFAULT_FORWARD_SESSIONS_MAXCOUNT	60000	/* È±Ê¡×î´óÁ¬½ÓÊıÁ¿ */
...
#define WAIT_EVENTS_COUNT			100 /* Ò»´Î»ñÈ¡epollÊÂ¼şÊıÁ¿ */
...
struct ForwardRule
{
	...
	union
	{
		struct
		{
			unsigned int	server_index ; /* ·şÎñ¶ËË÷Òı */
		} MS ;
		struct
		{
...
struct ForwardSession
{
	...
	unsigned long		io_buffer_len ; /* ÊäÈëÊä³ö»º³åÇøÓĞĞ§Êı¾İ³¤¶È */
...
struct ServerEnv
{
	...
	pid_t			pid ; /* ×Ó½ø³ÌPID */
	struct PipeFds		monitor_pipe ; /* ¸¸×Ó½ø³ÌÃüÁî¹ÜµÀ */
	...
	struct PipeFds		*accept_pipe_array ; /* ¸¸×ÓÏß³ÌÃüÁî¹ÜµÀ */
